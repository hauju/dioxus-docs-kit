...
Register both routes under your blog layout and point them at `BlogCategoryPage`; its `page` prop defaults to 1. The path must match `with_category_base_path`; you can use `/categories` or `/topics` instead.
