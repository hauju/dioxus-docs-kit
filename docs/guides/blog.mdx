...
In `MyBlogLayout`, derive the current category from the route alongside `current_slug`. Pass it to `BlogContext` to highlight the active category and close the mobile drawer after navigation:
