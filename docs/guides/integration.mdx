  ...
  <Step title="Create the docs layout wrapper">
    ...
    fn MyDocsLayout() -> Element {
        ...
        let docs_ctx = DocsContext {
            ...
            // Set to `Some("https://your-site.com".into())` in production.
            site_url: None,
            // Emit per-page title / description / OG / Twitter tags from
            // frontmatter. Set to `false` if your app manages its own <head>.
            auto_meta: true,
        };
