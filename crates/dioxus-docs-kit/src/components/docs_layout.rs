...
#[component]
pub fn DocsLayout(header: Option<Element>, children: Element) -> Element {
    ...
    let sidebar_top = if has_tabs {
        "sticky top-[6.5rem] h-[calc(100vh-6.5rem)]"
    } else {
        ...
        div { class: "min-h-screen bg-base-100",
            ...
            div { class: "flex",
                ...
                aside { class: "w-64 shrink-0 border-r border-base-300 bg-base-200/30 hidden lg:block",
                    div { class: "{sidebar_top} overflow-y-auto p-6",
                        DocsSidebar {}
                    }
                }
